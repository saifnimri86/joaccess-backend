...
export const translations = {
  en: {
    ...
    cv_analyze_short:  "AI",
    cv_analyzing:      "Analyzing photos…",
    cv_predicted:      "Predicted Class",
    cv_all_scores:     "All Class Scores",
    cv_match:          "Match",
    cv_mismatch:       "Mismatch",
    cv_failed:         "Failed",
    cv_summary:        "Summary",
    cv_claimed:        "Claimed",
    cv_inference_time: "Inference time",
    cv_no_photos:      "No photos to analyze",
    cv_waiting:        "Waiting for analysis…",
    cv_photo_failed:   "This photo could not be analyzed",
  ...
  ar: {
    ...
    cv_analyze_short:  "AI",
    cv_analyzing:      "جاري تحليل الصور…",
    cv_predicted:      "الفئة المتوقعة",
    cv_all_scores:     "نتائج جميع الفئات",
    cv_match:          "تطابق",
    cv_mismatch:       "عدم تطابق",
    cv_failed:         "فشل",
    cv_summary:        "ملخص",
    cv_claimed:        "المُدّعاة",
    cv_inference_time: "زمن التحليل",
    cv_no_photos:      "لا توجد صور للتحليل",
    cv_waiting:        "بانتظار التحليل…",
    cv_photo_failed:   "تعذر تحليل هذه الصورة",
    cv_err_title:      "فشل التحليل",
